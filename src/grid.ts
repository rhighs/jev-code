...
export interface TextProgress { decoder: 'grid' | 'ast' | 'choice'; step: number; cursor: GridCursor; grid?: GridProgress; bytes?: number; ast?: { production: string; slot: string; symbols: string[] } }
